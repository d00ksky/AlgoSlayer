...
class DynamicThresholdManager:
    ...
    def get_all_thresholds(self) -> Dict[str, Dict]:
        ...
        for strategy_id in ["conservative", "moderate", "aggressive", "scalping", "swing", "momentum", "volatility", "mean_reversion"]:
    ...
    def get_threshold_summary(self) -> str:
        ...
        for strategy_id, data in thresholds.items():
            emoji = {"conservative": "🛡️", "moderate": "⚖️", "aggressive": "🚀", "scalping": "⚡", "swing": "📈", "momentum": "🎯", "volatility": "💥", "mean_reversion": "↩️"}.get(strategy_id, "📊")
